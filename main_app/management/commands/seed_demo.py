    ...
    def handle(self, *args, **options):
        ...
        if LeaveReportStaff.objects.count() == 0:
            LeaveReportStaff.objects.create(
                ...
                message="Personal work in Pokhara",
                status=0,
            )
            LeaveReportStaff.objects.create(
                staff=teacher_profile,
        ...
        if KaajRequest.objects.count() == 0:
            KaajRequest.objects.create(
                staff=teacher_profile,
                purpose="Industry visit at Tech Park",
        ...
        if StoreRequisition.objects.count() == 0:
            ...
            if bulb:
                StoreRequisition.objects.create(
                    ...
                    item=bulb,
                    quantity=2,
                    reason="Lab-1 projector dimming",
                    status=0,
                )
        ...
        if LessonPlan.objects.count() == 0:
            LessonPlan.objects.create(
                ...
                subject=subj1,
                week_number=1,
                topics="Arrays, ADT, complexity analysis",
                is_lab=False,
                prepared_by=teacher_profile,
            )
            LessonPlan.objects.create(
                title="Lab 1: Array operations",
                subject=subj1,
                week_number=1,
                topics="Implement insertion, deletion, search",
                is_lab=True,
                prepared_by=teacher_profile,
            )
