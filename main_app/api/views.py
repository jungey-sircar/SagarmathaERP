...
from ..models import Staff, Subject, Student, Attendance, Course, LeaveReportStaff, Book, AttendanceReport
...
class HODDashboardAPIView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        attendance_list = [Attendance.objects.filter(subject=s).count() for s in department_subjects]
        ...
        data = {
            ...
            'role_detail': staff.role_detail or (staff.course.name if staff.course else ''),
